...
class GetRatingResponseForMessageId(Resource):
    ...
    def get(self):
        ...
        rating_request = get_bpp_response_for_message_id(request_type='rating', **args)
        on_rating_response = get_bpp_response_for_message_id(request_type='on_rating', **args)

        log_time_difference(rating_request,on_rating_response)
        return on_rating_response
