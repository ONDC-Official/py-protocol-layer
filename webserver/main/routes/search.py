...
class GetCataloguesForMessageId(Resource):
    ...
    def create_parser_with_args(self):
        ...
        parser.add_argument("providerId", dest="provider_id", required=False)
        parser.add_argument("categoryId", dest="category_id", required=False)
        parser.add_argument("fulfillmentId", dest="fulfillment_id", required=False)
