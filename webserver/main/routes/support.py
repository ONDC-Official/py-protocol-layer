...
class GetSupportResponseForMessageId(Resource):
    ...
    def get(self):
        ...
        support_request = get_bpp_response_for_message_id(request_type='support', **args)
        on_support_response = get_bpp_response_for_message_id(request_type='on_support', **args)

        log_time_difference(support_request,on_support_response)
        return on_support_response
